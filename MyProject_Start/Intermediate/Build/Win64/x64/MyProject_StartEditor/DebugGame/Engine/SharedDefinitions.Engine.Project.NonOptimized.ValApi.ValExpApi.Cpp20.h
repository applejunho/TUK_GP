// Generated by UnrealBuildTool (UEBuildModuleCPP.cs) : Shared Definitions for Engine.Project.NonOptimized.ValApi.ValExpApi.Cpp20
#pragma once
#define IS_PROGRAM 0
#define UE_EDITOR 1
...
#define ENGINE_NON_ATTRIBUTED_API DLLIMPORT
